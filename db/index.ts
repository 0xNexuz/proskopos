...
export async function ensureRuntimeSchema() {
  ...
  const statements = [
    ...
    `CREATE TABLE IF NOT EXISTS user_profiles (user_id TEXT PRIMARY KEY NOT NULL, display_name TEXT NOT NULL, goals TEXT DEFAULT '[]' NOT NULL, stacks TEXT DEFAULT '[]' NOT NULL, chains TEXT DEFAULT '[]' NOT NULL, specialties TEXT DEFAULT '[]' NOT NULL, experience_level TEXT DEFAULT 'Growing' NOT NULL, portfolio_url TEXT DEFAULT '' NOT NULL, min_reward INTEGER DEFAULT 0 NOT NULL, availability TEXT DEFAULT 'Flexible' NOT NULL, region TEXT DEFAULT 'Global' NOT NULL, scoped_only INTEGER DEFAULT 1 NOT NULL, alert_frequency TEXT DEFAULT 'Daily' NOT NULL, alert_channel TEXT DEFAULT 'In-app' NOT NULL, alert_destination TEXT DEFAULT '' NOT NULL, passport_headline TEXT DEFAULT 'Independent Web3 security researcher' NOT NULL, passport_bio TEXT DEFAULT '' NOT NULL, passport_slug TEXT DEFAULT '' NOT NULL, passport_public INTEGER DEFAULT 0 NOT NULL, github_url TEXT DEFAULT '' NOT NULL, audit_report_urls TEXT DEFAULT '[]' NOT NULL, onboarding_complete INTEGER DEFAULT 0 NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`,
    ...
    `CREATE TABLE IF NOT EXISTS watchlists (id TEXT PRIMARY KEY NOT NULL, user_id TEXT NOT NULL, name TEXT NOT NULL, stacks TEXT DEFAULT '[]' NOT NULL, categories TEXT DEFAULT '[]' NOT NULL, min_reward INTEGER DEFAULT 0 NOT NULL, verified_only INTEGER DEFAULT 0 NOT NULL, active INTEGER DEFAULT 1 NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`,
